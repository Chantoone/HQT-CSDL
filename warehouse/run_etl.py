...
if __name__ == "__main__":
    ...
    DestSession = None
    try:
        src_engine = create_engine("postgresql://postgres:admin@localhost:5433/hqt_csdl")
        dest_engine = create_engine("postgresql://postgres:admin@localhost:5433/warehouse")
